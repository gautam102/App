...
class SymptomAdapter(
    ...
    override fun getItemCount(): Int { return Symptoms.size }
    override fun onBindViewHolder(holder: SymptomAdapterViewHolder, position: Int) {
        holder.itemView.apply {
            ...
            holder.checkbox.isChecked = Symptoms[position].checked
            holder.checkbox.setOnCheckedChangeListener(null) // Clear existing listener
            holder.checkbox.setOnCheckedChangeListener { _, isChecked ->
                Symptoms[position].checked = !isChecked
            }
        }
    }
}
